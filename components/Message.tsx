...
export default function Message({ message }: { message: any }) {
  ...
  const messageContent = message.message.conversation || message.message.audioMessage || message.message.imageMessage || message.message.videoMessage || message.message.documentMessage
